...
if choice1 == "left":
   choice2= input("You've come to a lake. There is an island in the middle od the lake. Type 'wait' to wait for a boat. Type 'Swim' to swim across").lower()
   if choice2 == 'wait':
